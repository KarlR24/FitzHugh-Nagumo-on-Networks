...
where $a_{ij}$ denotes the entries of the adjacency matrix (for a given network). Note that this is equivalent to summing only over neighboring nodes and omitting the adjacency matrix.
